...
function Button({ onConfirm }: { onConfirm: () => void }) {
  return (
    <div className="absolute contents left-0 top-[394px]" data-name="button">
      <div className="absolute h-[92px] left-0 top-[394px] w-[360px]" data-name="np_02tr_btn_r8_buy_sld_n.9">
        ...
        <div
          ...
          onClick={onConfirm}
        >
          <div className="absolute bg-[#fa2d42] inset-0 rounded-[8px]" data-name="np_02tr_btn_r8_buy_sld_n.9" />
          <p className="absolute font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] inset-[26.92%_6.25%] leading-[24px] not-italic text-[16px] text-center text-white font-medium">매수주문</p>
        </div>
      </div>
    </div>
  );
...
function Text() {
  return (
    <div className="absolute contents left-[20px] top-[356px]" data-name="text">
      <Group1 />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute inset-[33.33%_33.33%_33.32%_33.33%]" data-name="Group818705">
...
function Button1() {
  return (
    <div className="absolute contents left-[191px] top-0" data-name="button">
      <div className="absolute bottom-[95.89%] flex flex-col font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] justify-center leading-[0] left-[58.61%] not-italic right-[5.56%] text-[13px] text-nowrap text-right text-white top-0">
      ...
      <div className="absolute left-[191px] size-[16px] top-[2px]" data-name="ic_00com_16_line_stopsel_o">
        <div className="absolute inset-[28.13%_18.75%_31.25%_18.75%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-3px_-4.5px] mask-size-[16px_16px]" style={{ maskImage: `url('${img}')` }}>
          <div className="absolute inset-[-11.54%_-7.5%]" style={{ "--stroke-0": "rgba(246, 246, 249, 1)" } as React.CSSProperties}>
...
function Text1() {
  return (
    <div className="absolute contents font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] left-[20px] not-italic text-[13px] top-[120px]" data-name="text">
      <p className="absolute leading-[20px] left-[340px] text-[#333950] text-nowrap text-right top-[152px] translate-x-[-100%] whitespace-pre font-medium">라일락 - IU</p>
      ...
      <p className="absolute leading-[20px] left-[340px] text-[#fa2d42] text-nowrap text-right top-[216px] translate-x-[-100%] whitespace-pre font-medium">15,000DT</p>
      <p className="absolute leading-[20px] left-[20px] text-[#777e8c] text-nowrap top-[248px] whitespace-pre font-medium">주문수량</p>
      <p className="absolute leading-[20px] left-[340px] text-[#fa2d42] text-nowrap text-right top-[248px] translate-x-[-100%] whitespace-pre font-medium">10ST</p>
      <p className="absolute leading-[20px] left-[20px] text-[#777e8c] text-nowrap top-[280px] whitespace-pre font-medium">주문금액</p>
      <p className="absolute leading-[20px] left-[340px] text-[#333950] text-nowrap text-right top-[280px] translate-x-[-100%] whitespace-pre font-medium">150,000DT</p>
      ...
      <div className="absolute flex flex-col justify-center leading-[0] left-[340px] text-[#777e8c] text-nowrap text-right top-[322px] translate-x-[-100%] translate-y-[-50%]">
      ...
      <p className="absolute bottom-[58.02%] leading-[20px] left-[340px] text-[#333950] text-right top-[37.86%] translate-x-[-100%] w-[224px] font-medium">지정가</p>
      ...
      <p className="absolute bottom-[71.19%] leading-[20px] left-[340px] text-[#333950] text-right top-[24.69%] translate-x-[-100%] w-[224px] font-medium">123-45-678910 [종합계좌] 김신한</p>
    </div>
  );
}

function Bottomsheet({ onClose, onConfirm }: { onClose: () => void; onConfirm: () => void }) {
  return (
    <div className="absolute contents inset-0" data-name="+ BOTTOMSHEET">
      ...
      <p className="absolute font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] inset-[15.64%_5.56%_79.42%_5.56%] leading-[26px] not-italic text-[#111111] text-[18px] tracking-[-0.5px] font-bold">
      ...
      <div
        ...
        onClick={onClose}
      >
        <div className="absolute inset-0" style={{ "--fill-0": "rgba(244, 246, 249, 1)" } as React.CSSProperties}>
...
export default function BuyOrderBottomSheet({ isOpen, onClose }: BuyOrderBottomSheetProps) {
  ...
  return (
    <>
      ...
      >
        <div className="relative size-full" data-name="(팝업)매수주문확인">
          <Bottomsheet onClose={onClose} onConfirm={handleConfirm} />
        </div>
      </div>
    </>
  );
