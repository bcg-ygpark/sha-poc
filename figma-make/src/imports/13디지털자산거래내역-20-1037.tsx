...
function Frame39() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#333950] text-[14px] text-nowrap whitespace-pre">환전 | USDC → DT</p>
      <Frame42 />
    </div>
  );
}
...
function Frame46() {
  return (
    <div className="content-stretch flex font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] items-center justify-between not-italic relative shrink-0 text-nowrap w-full whitespace-pre">
      <p className="leading-[20px] relative shrink-0 text-[#333950] text-[14px]">매수 | 라일락(LILAC)-IU</p>
      <p className="leading-[24px] relative shrink-0 text-[#2d78fa] text-[16px] text-right tracking-[-0.08px]">-150,150 원</p>
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="content-stretch flex font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] items-center justify-between not-italic relative shrink-0 text-nowrap w-full whitespace-pre">
      <p className="leading-[20px] relative shrink-0 text-[#333950] text-[14px]">배당금 | 라일락(LILAC)-IU</p>
      <p className="leading-[24px] relative shrink-0 text-[#fa2d42] text-[16px] text-right tracking-[-0.08px]">16,000 원</p>
    </div>
  );
}
...
function Frame53() {
  return (
    <div className="content-stretch flex font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] items-center justify-between not-italic relative shrink-0 text-nowrap w-full whitespace-pre">
      <p className="leading-[20px] relative shrink-0 text-[#333950] text-[14px]">매도 | Dynamite-BTS</p>
      <p className="leading-[24px] relative shrink-0 text-[#fa2d42] text-[16px] text-right tracking-[-0.08px]">499,800 원</p>
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute inset-[16.667%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-4px] mask-size-[24px_24px]" style={{ maskImage: `url('${img}')` }}>
