...
import img1 from "figma:asset/caaea4444e2cbaa2885cbabeaddc699ebe95dcb1.png";
...
function Quick1() {
  return (
    <div className="bg-[#f6f6f9] box-border content-stretch flex flex-col items-start pb-[52px] pt-[20px] px-0 relative shrink-0 w-[360px]" data-name="+Quick_주식">
      <Frame2117921334 />
    </div>
  );
}
...
export default function My() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative w-full min-h-full" data-name="MY홈_국내">
      <Header />
      <ContentsFooter />
      <div className="fixed bottom-0 left-0 right-0 w-full max-w-[360px] mx-auto z-50">
        <Quickmenu />
      </div>
    </div>
  );
