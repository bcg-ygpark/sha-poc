import svgPaths from "./svg-m03xeagq6h";
import { img, img1 } from "./svg-09obk";
...
function BtnMainN9() {
  return (
    <div className="absolute bottom-[20px] h-[52px] left-[5.56%] right-[5.56%]" data-name="btn_main_n.9">
...
function Frame2117921400() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-center w-full">
      <p className="font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] leading-[28px] relative shrink-0 text-[#111111] text-[20px] tracking-[-0.1px] w-full font-bold">입금을 처리하고 있어요</p>
...
function Frame2117921396() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex flex-col items-start ml-[30px] mt-0 not-italic relative w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#333950] text-[14px] w-full font-bold">MetaMask 승인 완료</p>
...
function Frame2117921398() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42px] items-start left-[54px] not-italic top-[170px] w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#aaaeb3] text-[14px] w-full font-bold">입금 확인 및 반영</p>
...
function Frame2117921397() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[54px] not-italic top-[102px] w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#333950] text-[14px] w-full font-bold">블록체인 컨펌 대기중</p>
...
function Frame2117921399() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42px] items-start left-[54px] not-italic top-[238px] w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#aaaeb3] text-[14px] w-full font-bold">환전 가능</p>
      <p className="basis-0 font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] grow leading-[18px] min-h-px min-w-px relative shrink-0 text-[#999ea4] text-[12px] w-full">대기중</p>
    </div>
  );
}
...
function Frame2117921384() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#333950] text-[12px] text-nowrap whitespace-pre font-bold">트랜잭션 정보</p>
      <Frame2117921406 />
    </div>
  );
}
...
export default function Component06() {
  return (
    <div className="bg-white relative size-full" data-name="06.입금진행중">
      <Frame2117921381 />
      <Btn />
      <Contents />
    </div>
